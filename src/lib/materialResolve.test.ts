...
// repräsentative Liste quer durch Böden/Wände/Fliesen
const SAMPLE_IDS = [
...
describe('Material-Mapping (Fix) — ID → korrekte Definition (kein Fallback)', () => {
  it('15+ Material-IDs lösen exakt auf das erwartete Material auf', () => {
    expect(SAMPLE_IDS.length).toBeGreaterThanOrEqual(15);
